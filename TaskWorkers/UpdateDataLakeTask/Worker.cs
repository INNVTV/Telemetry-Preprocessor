...
namespace UpdateDataLakeTask
{
    public class Worker : BackgroundService
    {
        ...
        public Worker(ILogger<Worker> logger, IDataLakeStorageSharedKey dataLakeStorageSharedKey, IPreprocessorStorageContext preprocessorStorageContext)
        {
            _logger = logger;
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            var queueName = Shared.Constants.QueueNames.DataLakeTask;
            ...
            while (!stoppingToken.IsCancellationRequested)
            {
                ...
                if (message != null)
                {
                    ...
                    // Run Task(s)
                    var result = await Tasks.UpdateDataLakeReports.RunAsync(_dataLakeStorageSharedKey, message);
