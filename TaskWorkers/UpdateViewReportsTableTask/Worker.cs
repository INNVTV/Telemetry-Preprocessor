...
namespace UpdateViewReportsTableTask
{
    public class Worker : BackgroundService
    {
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            var queueName = Shared.Constants.QueueNames.ViewReportsTableTask;
            ...
            while (!stoppingToken.IsCancellationRequested)
            {
                ...
                if (message != null)
                {
                    ...
                    // Run Task(s)
                    var result = await Tasks.UpdateViewReportsTable.RunAsync(_applicationStorageContext, message);
